...
impl SubChunk {
    ...
    #[inline]
    pub const fn index_of(position: glam::USizeVec3) -> usize {
    ...
    #[must_use]
    #[inline]
    pub fn get_block_unchecked(&self, position: glam::USizeVec3) -> &SubChunkBlockState {
...
impl Chunk {
    ...
    pub const fn corner(position: glam::USizeVec3) -> Option<[glam::IVec2; 3]> {
        match (position.x, position.z) {
            (0, 0) => Some([glam::IVec2::NEG_X, glam::IVec2::NEG_Y, glam::IVec2::NEG_ONE]),
            (0, SUBCHUNK_XZ_MAX) => Some([glam::IVec2::NEG_X, glam::IVec2::Y, glam::IVec2::new(-1, 1)]),
            (SUBCHUNK_XZ_MAX, 0) => Some([glam::IVec2::X, glam::IVec2::NEG_Y, glam::IVec2::new(1, -1)]),
            (SUBCHUNK_XZ_MAX, SUBCHUNK_XZ_MAX) => Some([glam::IVec2::X, glam::IVec2::Y, glam::IVec2::ONE]),
            _ => None,
        }
    }

    #[inline]
    pub const fn side(position: glam::USizeVec3) -> Option<glam::IVec2> {
        if position.x == 0 {
            Some(glam::IVec2::NEG_X)
        } else if position.x == SUBCHUNK_XZ_MAX {
            Some(glam::IVec2::X)
        } else if position.z == 0 {
            Some(glam::IVec2::NEG_Y)
    ...
    pub const fn to_origin_and_local(position: glam::IVec3) -> (glam::IVec2, glam::USizeVec3) {
        ...
        let origin = glam::IVec2::new((position.x - local_x) / SUBCHUNK_SIZE_I32, (position.z - local_z) / SUBCHUNK_SIZE_I32);
        let local = glam::USizeVec3::new(local_x as usize, position.y as usize, local_z as usize);

        (origin, local)
    }

    #[inline]
    pub const fn to_local(position: glam::IVec3) -> glam::USizeVec3 {
        glam::USizeVec3::new(
    ...
    #[inline]
    pub const fn to_world_pos(origin: glam::IVec2, position: glam::USizeVec3) -> glam::IVec3 {
        let glam::IVec2 { x, y } = origin;
    ...
    #[inline]
    pub const fn to_world(&self, position: glam::USizeVec3) -> glam::IVec3 {
        Self::to_world_pos(self.origin, position)
    }

    #[inline]
    pub const fn contains_local_position(&self, position: glam::USizeVec3) -> bool {
        position.x < SUBCHUNK_SIZE && position.y < (SUBCHUNK_SIZE * SUBCHUNK_COUNT) && position.z < SUBCHUNK_SIZE
    }

    #[inline]
    pub fn contains_position(&self, position: glam::IVec3) -> bool {
        self.origin.x == (position.x >> 4) && self.origin.y == (position.z >> 4) && (0..SUBCHUNK_COUNT_I32).contains(&(position.y >> 4))
    }

    #[inline]
    pub fn set_block(&mut self, position: glam::USizeVec3, block: SubChunkBlockState) {
    ...
    #[inline]
    pub fn get_block(&self, position: glam::USizeVec3) -> Option<&SubChunkBlockState> {
        if self.contains_local_position(position) {
    ...
    pub fn get_block_unchecked(&self, position: glam::USizeVec3) -> &SubChunkBlockState {
        ...
        unsafe { self.subchunks.get_unchecked(subchunk).get_block_unchecked(glam::USizeVec3 { y, ..position }) }
    }
    ...
    #[inline]
    pub fn set_biome_unchecked(&mut self, position: glam::USizeVec2, biome: Biome) {
        unsafe {
    ...
    #[must_use]
    #[inline]
    pub fn get_biome_unchecked(&self, position: glam::USizeVec2) -> Biome {
    ...
    #[inline]
    pub fn get_light_level_unchecked(&self, position: glam::USizeVec3) -> u8 {
        let [subchunk, y] = Self::get_subchunk_index(position.y);
        ...
        unsafe {
            *self
                ...
                .light_levels
                .get_unchecked(SubChunk::index_of(glam::USizeVec3 { y, ..position }))
        }
    }

    #[inline]
    pub const fn get_light_level(&self, position: glam::USizeVec3) -> u8 {
        let [subchunk, y] = Self::get_subchunk_index(position.y);

        self.subchunks[subchunk].light_levels[SubChunk::index_of(glam::USizeVec3 { y, ..position })]
    }
    ...
    #[inline]
    pub const fn get_light_level_mut(&mut self, position: glam::USizeVec3) -> &mut u8 {
        let [subchunk, y] = Self::get_subchunk_index(position.y);

        &mut self.subchunks[subchunk].light_levels[SubChunk::index_of(glam::USizeVec3 { y, ..position })]
    }

    #[inline]
    pub fn check_for_local_block(&self, local_position: glam::USizeVec3) -> bool {
        let [subchunk, y] = Self::get_subchunk_index(local_position.y);

        !self.subchunks[subchunk]
            .get_block_by_idx_unchecked(SubChunk::index_of(glam::USizeVec3 { y, ..local_position }))
            .is_air()
    }

    #[inline]
    pub fn check_for_block(&self, position: glam::IVec3) -> bool {
        self.contains_position(position) && self.check_for_local_block(Self::to_local(position))
    }

    #[inline]
    pub const fn get_light(&self, position: glam::USizeVec3, is_sky_light: bool) -> u8 {
        if is_sky_light {
    ...
    #[inline]
    pub const fn set_light(&mut self, position: glam::USizeVec3, is_sky_light: bool, value: u8) {
        if is_sky_light {
    ...
    #[inline]
    pub const fn get_sky_light(&self, position: glam::USizeVec3) -> u8 {
    ...
    #[inline]
    pub fn get_sky_light_unchecked(&self, position: glam::USizeVec3) -> u8 {
    ...
    #[inline]
    pub const fn set_sky_light(&mut self, position: glam::USizeVec3, value: u8) {
    ...
    #[inline]
    pub const fn get_block_light(&self, position: glam::USizeVec3) -> u8 {
        self.get_light_level(position) & 0xF
    }

    #[inline]
    pub fn get_block_light_unchecked(&self, position: glam::USizeVec3) -> u8 {
    ...
    #[inline]
    pub const fn set_block_light(&mut self, position: glam::USizeVec3, value: u8) {
        let level = self.get_light_level_mut(position);
    ...
    #[inline]
    pub fn new(origin: glam::IVec2) -> Self {
...
impl<'a> IntoIterator for &'a Chunk {
    ...
    type Item = (glam::USizeVec3, &'a SubChunkBlockState);
...
impl<'a> ChunkFaceIter<'a> {
    ...
    pub const fn new(chunk: &'a Chunk, face: Face) -> Self {
        let min = match face {
            Face::Right => glam::USizeVec3::new(SUBCHUNK_XZ_MAX, 0, 0),
            Face::Top => glam::USizeVec3::new(0, CHUNK_HEIGHT - 1, 0),
            Face::Front => glam::USizeVec3::new(0, 0, SUBCHUNK_XZ_MAX),
            Face::Left | Face::Back | Face::Bottom => glam::USizeVec3::ZERO,
        };

        let max = match face {
            Face::Left => glam::USizeVec3::new(1, CHUNK_HEIGHT, SUBCHUNK_SIZE),
            Face::Bottom => glam::USizeVec3::new(SUBCHUNK_SIZE, 1, SUBCHUNK_SIZE),
            Face::Back => glam::USizeVec3::new(SUBCHUNK_SIZE, CHUNK_HEIGHT, 1),
            Face::Right | Face::Top | Face::Front => glam::USizeVec3::new(SUBCHUNK_SIZE, CHUNK_HEIGHT, SUBCHUNK_SIZE),
        };
...
impl<'a> Iterator for ChunkFaceIter<'a> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        if self.y == self.max.y {
            ...
            let position = glam::USizeVec3::new(self.x, self.y, self.z);
...
impl<'a> Iterator for ChunkIter<'a> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        if self.y == CHUNK_HEIGHT {
            ...
            let position = glam::USizeVec3::new(self.x, self.y, SUBCHUNK_XZ_MAX);
            ...
            let position = glam::USizeVec3::new(SUBCHUNK_XZ_MAX, self.y, self.z);
...
impl<'a> Iterator for SubChunkIter<'a> {
    type Item = (glam::USizeVec3, Option<&'a SubChunkBlockState>);
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        let chunk_local_position = glam::USizeVec3::new(local_x, self.world_y_offset + local_y, local_z);
